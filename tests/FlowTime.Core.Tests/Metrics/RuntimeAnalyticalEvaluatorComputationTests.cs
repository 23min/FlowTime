...
public class RuntimeAnalyticalEvaluatorComputationTests
{
    ...
    public void ComputeWindow_ServiceWithBuffer_ReturnsAllSeries()
    {
        ...
        var result = RuntimeAnalyticalEvaluator.ComputeWindow(descriptor, data, startBin: 0, count: 4, binMs: BinMs);
    ...
    public void ComputeWindow_ServiceOnly_NoQueueSeries()
    {
        ...
        var result = RuntimeAnalyticalEvaluator.ComputeWindow(descriptor, data, startBin: 0, count: 2, binMs: BinMs);
    ...
    public void ComputeWindow_StartBinOffset_ReadsCorrectSlice()
    {
        ...
        var result = RuntimeAnalyticalEvaluator.ComputeWindow(descriptor, data, startBin: 2, count: 2, binMs: BinMs);
    ...
    public void ComputeWindow_BeyondDataLength_ReturnsNulls()
    {
        ...
        var result = RuntimeAnalyticalEvaluator.ComputeWindow(descriptor, data, startBin: 0, count: 3, binMs: BinMs);
    ...
    public void ComputeClassBin_ServiceWithBuffer_ReturnsAllMetrics()
    {
        ...
        var result = RuntimeAnalyticalEvaluator.ComputeClassBin(descriptor, snapshot, BinMs);
    ...
    public void ComputeClassWindow_ServiceWithBuffer_ReturnsAllSeries()
    {
        ...
        var result = RuntimeAnalyticalEvaluator.ComputeClassWindow(descriptor, classData, startBin: 0, count: 2, binMs: BinMs);
    ...
    public void ComputeClassWindow_NullClassData_ReturnsNulls()
    {
        ...
        var result = RuntimeAnalyticalEvaluator.ComputeClassWindow(descriptor, classData, startBin: 0, count: 1, binMs: BinMs);
