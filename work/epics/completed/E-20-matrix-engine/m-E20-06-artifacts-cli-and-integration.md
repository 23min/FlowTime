# Milestone: Artifacts, CLI, and Integration
...
m-E20-05 delivered derived metrics and invariant analysis. The engine now handles the full computation pipeline: parsing, compilation, evaluation, derived metrics, and warnings. 113 Rust tests passing.
...
- m-E20-05 complete (derived metrics, analysis, warnings)
