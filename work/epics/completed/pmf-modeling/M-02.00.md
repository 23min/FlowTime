# Milestone M-2 — PMF Support

> **📋 Charter Notice**: This completed milestone predates the [FlowTime-Engine Charter](../../../../docs/flowtime-engine-charter.md). PMF functionality remains core to the charter execution engine. See [ROADMAP.md](../../../../ROADMAP.md) for current development milestones.
