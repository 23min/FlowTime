# Milestone M-01.05 — Expressions & Built-ins

> **📋 Charter Notice**: This completed milestone predates the [FlowTime-Engine Charter](../../../../docs/flowtime-engine-charter.md). Expression language capabilities delivered here remain core to the charter execution engine. See [ROADMAP.md](../../../../ROADMAP.md) for current milestones.
