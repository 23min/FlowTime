...
- `work/epics/completed/ai/mcp-analyst.md`: read-only analyst over the digital twin.
- `work/epics/completed/ai/mcp-server-architecture.md`: initial MCP tool surface for graph/state inspection.
- `work/epics/completed/ai/mcp-modeling-tools.md`: authoring, run, and promotion tool schemas.
- `work/epics/completed/ai/mcp-server-implementation-plan.md`: Node/Python implementation plan and .NET note.
...
Detailed tool schemas live in `work/epics/completed/ai/mcp-modeling-tools.md`.
...
- `ROADMAP.md`
- `docs/modeling.md`
- `work/epics/completed/ai/mcp-analyst.md`
