...
This folder captures the authoritative time-travel architecture for the FlowTime.Sim surface. It complements the existing Engine-focused chapters under `work/epics/completed/time-travel/` and translates their KISS principles into concrete expectations for template authoring, services, validation, and testing on the simulation side.
