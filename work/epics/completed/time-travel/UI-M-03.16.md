...
- Document RED/GREEN transitions in `work/epics/completed/time-travel/UI-M-03.16-log.md` as tests are added/passing.
...
- `work/epics/completed/time-travel/UI-M-03.12.md`
- `work/epics/completed/time-travel/UI-M-03.15.md`
