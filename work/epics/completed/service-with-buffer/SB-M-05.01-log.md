...
- **Milestone Document:** [`work/epics/completed/service-with-buffer/SB-M-05.01.md`](SB-M-05.01.md)
...
- Recorded the migration summary inside `work/epics/completed/service-with-buffer/SB-M-05.01.md` (Implementation Notes) to capture the before/after context required by Task 2.3.
...
- [x] Golden template comparisons show no numerical regressions (`flow-sim generate` runs recorded in work/epics/completed/service-with-buffer/SB-M-05.01.md)
