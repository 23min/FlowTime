...
- **Milestone Document:** `work/epics/completed/service-with-buffer/FT-M-05.13-servicewithbuffer-parallelism-capacity.md`
...
**Wrap Actions:**
- [x] Kept milestone spec in `work/milestones/` per epic archiving policy.
...
**File(s):** `src/FlowTime.UI/Services/MetricProvenanceCatalog.cs`, `work/epics/ui/metric-provenance.md`
