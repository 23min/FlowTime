...
- **Anomaly Detection (work/epics/anomaly-detection/spec.md)**  
...
- **EdgeTimeBin (work/epics/completed/edge-time-bin/spec.md)**  
...
For a full design record and telemetry guidance, see `work/epics/completed/service-with-buffer/sink-node-architecture.md`.
