...
See `service-with-buffer-architecture.md` in this folder for the detailed proposal and `work/epics/completed/service-with-buffer/SB-M-05.01.md` for the corresponding milestone spec.
