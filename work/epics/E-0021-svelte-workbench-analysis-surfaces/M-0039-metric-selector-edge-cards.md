---
id: M-0039
title: Metric Selector & Edge Cards
status: done
parent: E-0021
acs:
  - id: AC-1
...
M-0038 delivered the workbench foundation: density system, dag-map click/hover events, and node cards with utilization-based heatmap coloring. But the topology only colors by utilization (hardcoded), there's no way to inspect edges, and class filtering doesn't exist.
...
**Existing Playwright specs still pass.** The M-0038 workbench specs and E-0017 what-if specs continue to work.
## Technical Notes
