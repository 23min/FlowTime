---
id: E-0013
title: Path Analysis & Subgraph Queries
status: proposed
---
...
Path analysis is built on EdgeTimeBin, Classes‑as‑Flows, and the stable post-E-0016 fact surfaces exposed by the server. It is consumed by both the UI and MCP server. It is not a replacement for edge overlays; it is a higher‑order analysis layer.
...
- Stable post-E-0016 server-provided state/graph facts and contracts
...
Suggested phases:
1. Path query contract + subgraph responses on stable post-E-0016 fact surfaces.
