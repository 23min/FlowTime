...
It is designed to fit the pluggable layout motor architecture described in [work/epics/ui-layout/spec.md](work/epics/ui-layout/spec.md).
...
Place the screenshot at `work/epics/ui-layout/images/metro-reference.png`.
...
- [work/epics/ui-layout/spec.md](work/epics/ui-layout/spec.md) defines the abstraction: input/options/result, signatures, and server vs client layout.
