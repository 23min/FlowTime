...
- **No computation:** This milestone deliberately excludes compilation, evaluation, and artifact writing. The types and parsers are the foundation; computation starts in M-0029.
...
- Model compilation (topo sort, column map, plan generation) — M-0029
- Evaluation (matrix ops) — M-0029+
- Model validation (schema checks, initial condition validation) — M-0029+
- Artifact writing — M-0033
- WebAssembly compilation — future
- Expression evaluation (only parsing) — M-0029

## Dependencies

- None (first milestone in E-0020)
