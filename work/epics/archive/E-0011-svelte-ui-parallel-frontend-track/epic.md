...
|----|-------|---------|--------|
| M-0061 | Project scaffold & shell | SvelteKit + shadcn-svelte + Tailwind + layout shell with sidebar | **done** |
...
| M-0062 | Run orchestration | Card-based template selection, bundle reuse, domain icons | not started |
...
### M1 — Project Scaffold & Shell (M-0061)
