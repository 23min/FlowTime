...
Establish the compact design system, implement dag-map click/hover events in the library, and build the workbench panel with click-to-pin node inspection — the foundation that every subsequent E-0021 milestone builds on.
...
- Edge cards (M-0039)
- Metric selector chip bar (M-0039)
- Class filter (M-0039)
- Analysis tab surfaces (M-0040/04)
- Heatmap view (M-0042)
- Validation/warning surfaces (M-0043)
- Final visual polish and dark mode QA (M-0044)
...
- E-0018 Time Machine APIs available on port 8081 (already merged to main)
- E-0017 what-if infrastructure (`/what-if` route, engine session API) — must not regress
- E-0011 M6 run orchestration (`/run` route) — must not regress
