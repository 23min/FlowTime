...
- Classes as flows (`work/epics/completed/classes/spec.md`).
- EdgeTimeBin foundations (`work/epics/completed/edge-time-bin/spec.md`).
- Engine semantics layer (`work/epics/completed/engine-semantics-layer/spec.md`).
