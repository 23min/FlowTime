...
- [m-E24-03-schema-unification](./m-E24-03-schema-unification.md) — **in-progress (started 2026-04-25, branch `milestone/m-E24-03-schema-unification`).** Rewrite `docs/schemas/model.schema.yaml` to describe the unified type. camelCase provenance block. Apply every m-E24-01 decision: `outputs[].as`, `classes: minItems`, `nodes[].source`, provenance shape. Update `docs/schemas/README.md` and any architecture doc that still describes the two-schema world. · depends on: m-E24-02
