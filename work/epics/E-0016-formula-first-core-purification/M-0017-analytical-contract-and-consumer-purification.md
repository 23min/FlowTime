...
acs:
  ...
  - id: AC-4
    ...
    status: met
  - id: AC-5
    title: Documentation and decision records are updated so E-0010 Phase 3 can
    status: met
---
...
### AC-5 — Documentation and decision records are updated so E-0010 Phase 3 can

Documentation and decision records are updated so E-0010 Phase 3 can resume on the purified boundary.
## Guards / DO NOT
...
| `EnsureFallbackClassesFromWindow()` (if survived M-0013) | Dashboard.razor.cs | Client-side class fallback heuristic |
...
- Svelte UI migration (E-0011) — the four named files are Blazor UI
