...
- **DO NOT** introduce a second parallel analytical warning pipeline or result surface beside the consolidated internal analytical result family established in M-0015.
...
- Extend the consolidated analytical result family from M-0015 rather than inventing a second analytical warning surface.
...
- Public contract redesign (M-0017)
- UI/client heuristic deletion (M-0017)
