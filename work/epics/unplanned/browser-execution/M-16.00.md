# Milestone M-16 — WASM Engine (Browser‑Run) — Future

> **📋 Charter Notice**: This future milestone predates the [FlowTime-Engine Charter](../../../docs/flowtime-engine-charter.md). WASM capabilities may be reconsidered within the charter execution framework. See [ROADMAP.md](../../../ROADMAP.md) for current development priorities.
