...
Builds on:
- M-0001 `evaluate_with_params` in the Rust engine (compile-once foundation)
- M-0004 `FlowTime.TimeMachine` project (host for the sweep domain model)
- M-0005 `ITelemetrySource` (pattern for injectable evaluation contracts)
