# Milestone: Parameterized Evaluation

**ID:** m-E18-01
**Epic:** E-18 Time Machine
**Status:** in-progress
**Branch:** `milestone/m-E18-01-parameterized-evaluation` (off `main`)
...
- Session management or persistent process (m-E18-02)
- Streaming protocol or MessagePack framing (m-E18-02)
- CLI interface changes (m-E18-02)
