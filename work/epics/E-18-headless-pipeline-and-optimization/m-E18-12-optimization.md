# m-E18-12 — Multi-parameter Optimization
...
Builds on:
- `IModelEvaluator` seam (m-E18-09)
- `ConstNodePatcher` for multi-parameter YAML mutation (m-E18-09)
- `ConstNodeReader` (m-E18-10) — used in tests to read patched values
