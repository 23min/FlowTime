---
id: E-0010
title: Engine Correctness & Analytical Primitives
status: done
---
...
3. Analytical projection hardening bridge: move the current state-query analytical capability/computation surface into Core, stabilize snapshot/window outputs, and hand the remaining formula-first purification work to E-0016
...
- UI changes
- MCP changes (M-0065 deferred to gaps.md)
...
- Remaining Phase 3 expansion resumes after E-0016 completion in the order `p3d` -> `p3c` -> `p3b`
...
| M-0054 | Phase 1: Engineering foundation | complete |
| M-0055 | Phase 2: Documentation honesty | complete |
| M-0056 | Phase 3a: Cycle time & flow efficiency | complete |
| M-0057 | Phase 3a.1: Analytical projection hardening | complete |
| M-0058 | Phase 3b: WIP limits | complete |
| M-0059 | Phase 3c: Variability (Cv + Kingman) | complete |
| M-0060 | Phase 3d: Constraint enforcement | complete |

**Architecture gate:** `m-ec-p3a1` is the bridge milestone that moved the current analytical capability/computation surface into Core. E-0016 owned the remaining formula-first purification work exposed by that review, and with E-0016 complete Phase 3 resumes with `p3d` -> `p3c` -> `p3b`.
...
- `work/gaps.md` — Deferred M-0065 (depends on runtime constraint enforcement in `p3d`)
