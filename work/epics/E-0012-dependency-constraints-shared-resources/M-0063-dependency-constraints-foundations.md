...
### Out of Scope
- **Option B (constraint attached to service nodes)** — deferred to M-0064.
...
- Option B (dependency as constraint) is defined in M-0064 and builds on the same series/edge semantics.
