...
- **Status:** In-progress (branch `epic/E-21-svelte-workbench-and-analysis`). m-E21-01/02/03/04/05 merged to epic (m-E21-01/02 merged 2026-04-17; m-E21-03 Sweep & Sensitivity Surfaces merged 2026-04-17 with ultrareview follow-ups 2026-04-20; m-E21-04 Goal Seek Surface completed 2026-04-22; **m-E21-05 Optimize Surface completed 2026-04-22** — live `/v1/optimize` wired to the `/analysis` Optimize tab, N-param Nelder-Mead, per-param bounds table + range bars, new `flowtime.optimize(...)` client, sibling `optimize-helpers.ts` module). Scope split 2026-04-21 during m-E21-04: Optimize moved to new m-E21-05; downstream milestones renumbered heatmap → m-E21-06, validation → m-E21-07, polish → m-E21-08 (epic now has 8 milestones, was 7). **Remaining:** m-E21-06 Heatmap View, m-E21-07 Validation Surface, m-E21-08 Polish.
