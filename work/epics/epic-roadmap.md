...
- **Status:** In-progress (branch `epic/E-21-svelte-workbench-and-analysis`). m-E21-01/02/03/04/05 merged to epic (m-E21-01/02 merged 2026-04-17; m-E21-03 Sweep & Sensitivity Surfaces merged 2026-04-17 with ultrareview follow-ups 2026-04-20; m-E21-04 Goal Seek Surface completed 2026-04-22; m-E21-05 Optimize Surface completed 2026-04-22). **m-E21-06 Heatmap View in-progress 2026-04-23** (branch `milestone/m-E21-06-heatmap-view`) — sibling-of-topology heatmap, typed `<ViewSwitcher>` with inline views, shared view-state store, shared full-window 99p-clipped normalization (ADR-m-E21-06-02: topology straight-swaps from per-bin), shared-toolbar `[ Operational | Full ]` node-mode toggle reaching Blazor parity. Scope split 2026-04-21 during m-E21-04: Optimize moved to new m-E21-05; downstream milestones renumbered heatmap → m-E21-06, validation → m-E21-07, polish → m-E21-08 (epic now has 8 milestones, was 7). **Remaining:** m-E21-07 Validation Surface, m-E21-08 Polish.
