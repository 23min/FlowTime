...
- **Status:** In-progress — m-E24-01 Inventory & Design Decisions **complete (2026-04-25, commit `c43e8c0`)**; m-E24-02 Unify Model Type next. Epic integration branch `epic/E-24-schema-alignment` (created from `main` 2026-04-24). Internal planning ratified **Option E (unify)** on 2026-04-24 per `D-2026-04-24-037`. Interrupts E-23 at m-E23-01.
...
- **Key milestones (5):** m-E24-01 Inventory & Design Decisions — **complete (2026-04-25, commit `c43e8c0`)**; doc-only; unified type home (`FlowTime.Contracts`), name (`ModelDto`), nested 7-field camelCase provenance shape, six open questions ratified (Q1–Q6 + A1–A5) · m-E24-02 Unify Model Type (delete `SimModelArtifact` + satellites; rewrite `SimModelBuilder`; switch Engine intake; regenerate fixtures) · m-E24-03 Schema Unification (rewrite schema + `docs/schemas/README.md`) · m-E24-04 Parser/Validator Scalar-Style Fix (mirrored) · m-E24-05 Canary Green + Hard Assertion
