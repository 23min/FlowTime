...
- **Status:** In-progress (branch `epic/E-21-svelte-workbench-and-analysis`). m-E21-01/02/03/04 merged to epic (m-E21-01/02 merged 2026-04-17; m-E21-03 Sweep & Sensitivity Surfaces merged 2026-04-17 with ultrareview follow-ups 2026-04-20; **m-E21-04 Goal Seek Surface completed 2026-04-22** — backend `trace` on `/v1/goal-seek` and `/v1/optimize` per D-2026-04-21-034, shared `AnalysisResultCard` + `ConvergenceChart` components). Scope split 2026-04-21 during m-E21-04: Optimize moved to new m-E21-05; downstream milestones renumbered heatmap → m-E21-06, validation → m-E21-07, polish → m-E21-08 (epic now has 8 milestones, was 7). **Active milestone:** m-E21-05 Optimize Surface (started 2026-04-22, branch `milestone/m-E21-05-optimize`) — N-param Nelder-Mead surface reusing m-E21-04 shared components + sibling `optimize-helpers.ts`.
