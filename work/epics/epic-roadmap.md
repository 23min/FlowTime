...
- **Status:** m-E19-01 and m-E19-02 completed, m-E19-03 in-progress; Blazor remains supported in parallel with E-11
...
- **Key milestones:** supported surface inventory (completed) → runtime endpoint/client cleanup (completed) → schema/template/example retirement (in-progress) → Blazor support alignment
