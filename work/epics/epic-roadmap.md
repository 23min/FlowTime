...
- **Status:** m-E19-01, m-E19-02, and m-E19-03 completed, m-E19-04 in progress; Blazor remains supported in parallel with E-11
...
- **Key milestones:** supported surface inventory (completed) → runtime endpoint/client cleanup (completed) → schema/template/example retirement (completed) → Blazor support alignment (in progress)
