...
- **Status:** In-progress — m-E24-01 Inventory & Design Decisions **complete (2026-04-25, commit `c43e8c0`)**; m-E24-02 Unify Model Type **complete (2026-04-25, commits `131dd35` / `c4064bf` / `3806097` / `dece22f`)**; m-E24-03 Schema Unification **in-progress (started 2026-04-25, branch `milestone/m-E24-03-schema-unification`)**. Epic integration branch `epic/E-24-schema-alignment` (created from `main` 2026-04-24). Internal planning ratified **Option E (unify)** on 2026-04-24 per `D-2026-04-24-037`. Interrupts E-23 at m-E23-01.
...
- **Key milestones (5):** m-E24-01 Inventory & Design Decisions — **complete (2026-04-25, commit `c43e8c0`)**; doc-only; unified type home (`FlowTime.Contracts`), name (`ModelDto`), nested 7-field camelCase provenance shape, six open questions ratified (Q1–Q6 + A1–A5) · m-E24-02 Unify Model Type — **complete (2026-04-25, commits `131dd35` / `c4064bf` / `3806097` / `dece22f`)**; all 14 ACs landed; `ModelDto`+`ProvenanceDto` in `FlowTime.Contracts`; `SimModelArtifact` + 6 satellites deleted; `SimModelBuilder` rewritten; Engine intake unified; YamlDotNet 17.0.1; 1,755 tests passing · m-E24-03 Schema Unification — **in-progress (started 2026-04-25, branch `milestone/m-E24-03-schema-unification`)**; rewrite schema + `docs/schemas/README.md` · m-E24-04 Parser/Validator Scalar-Style Fix (mirrored) · m-E24-05 Canary Green + Hard Assertion
