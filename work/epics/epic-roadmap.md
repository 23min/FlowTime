...
- **Status:** m-E19-01 completed, m-E19-02 in-progress; Blazor remains supported in parallel with E-11
...
- **Key milestones:** supported surface inventory (completed) → runtime endpoint/client cleanup (in-progress) → schema/template/example retirement → Blazor support alignment
