...
- Docs: contracts in `work/epics/completed/time-travel/time-travel-architecture-ch2-data-contracts.md` and UI mapping notes in `work/epics/completed/time-travel/ui-m3-roadmap.md`.
- Tests:
...
- `work/epics/completed/time-travel/time-travel-architecture-ch2-data-contracts.md` — add response shapes.
- `work/epics/completed/time-travel/ui-m3-roadmap.md` — reference endpoints and confirm Phase 2 wiring.
