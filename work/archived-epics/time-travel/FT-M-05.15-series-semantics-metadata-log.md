...
- **Milestone Document:** `work/epics/completed/time-travel/FT-M-05.15-series-semantics-metadata.md`
...
**File(s):** `work/epics/ui/metric-provenance.md`, `docs/templates/template-authoring.md`
