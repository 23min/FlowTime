...
- [ ] UI-M-03.10 — UI Baseline & Build Health (see: work/epics/completed/time-travel/UI-M-03.10.md)
- [ ] UI-M-03.11 — Artifacts Page Restoration (see: work/epics/completed/time-travel/UI-M-03.11.md)
- [ ] UI-M-03.12 — Simulate → Run Bundle Integration (see: work/epics/completed/time-travel/UI-M-03.12.md)
...
Refer to the roadmap for phase scope and sequencing: work/epics/completed/time-travel/ui-m3-roadmap.md
