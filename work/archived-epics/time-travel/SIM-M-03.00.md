...
- Documentation under `work/epics/completed/time-travel/sim/`

### Files to Create
- New template/validator classes (e.g., `TemplateTopology.cs`, `TopologyValidator.cs`)
- Migration guide snippet under `work/epics/completed/time-travel/sim/`
- Optional integration smoke test fixture.

---

## References
- `work/epics/completed/time-travel/time-travel-planning-roadmap.md` (Sim WS1/WS2 context)
- `work/epics/completed/time-travel/sim/sim-implementation-plan.md`
