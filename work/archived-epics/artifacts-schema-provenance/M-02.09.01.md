# M-02.09 — Schema Evolution & Documentation
...
> **See**: [`docs/architecture/rng-algorithm.md`](../../../../docs/architecture/rng-algorithm.md) for detailed algorithm selection rationale, performance analysis, and comparison with alternatives.
...
```json
{
  ...
  "seriesHashes": {},
  "eventCount": 0,
  "createdUtc": "2025-09-25T12:05:00Z",
