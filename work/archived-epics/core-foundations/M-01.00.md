...
> **📋 Charter Notice**: This milestone predates the [FlowTime-Engine Charter](../../../../docs/flowtime-engine-charter.md). Expression capabilities remain core to the charter execution engine. See [ROADMAP.md](../../../../ROADMAP.md) for current development milestones.
