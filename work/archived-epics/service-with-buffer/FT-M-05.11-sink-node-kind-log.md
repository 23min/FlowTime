...
- **Milestone Document:** `work/epics/completed/service-with-buffer/FT-M-05.11-sink-node-kind.md`
- **Related Analysis:** `work/epics/completed/service-with-buffer/service-with-buffer-architecture-part2.md`
...
**Docs:**
- Added sink-specific architecture guidance in `work/epics/completed/service-with-buffer/sink-node-architecture.md`.
- Updated sink section in `work/epics/completed/service-with-buffer/service-with-buffer-architecture-part2.md` to reflect current sink semantics.
