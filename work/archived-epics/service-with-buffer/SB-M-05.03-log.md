...
- **Milestone Document:** [`work/epics/completed/service-with-buffer/SB-M-05.03.md`](SB-M-05.03.md)
- **Architecture Note:** [`work/epics/completed/service-with-buffer/service-with-buffer-architecture.md`](../../architecture/service-with-buffer/service-with-buffer-architecture.md)
...
- Updated doc stubs (`docs/templates/template-authoring.md`, `work/epics/completed/service-with-buffer/...`) to describe queue/dlq parity.
...
- Logged the remaining router work (implicit router synthesis, helper removal) in `work/epics/completed/service-with-buffer/SB-M-05.03.md` as a documented gap that spawns the follow-up milestone (`SB-M-05.03-router` placeholder).
...
**Files:** `docs/templates/template-authoring.md`, `templates/README.md`, `work/epics/completed/service-with-buffer/service-with-buffer-architecture.md`, `work/epics/completed/service-with-buffer/SB-M-05.03.md`, `docs/releases/SB-M-05.03.md`
...
2. **Setup Phase (First Commit):**
   - Copy this template to `work/epics/completed/service-with-buffer/[MILESTONE-ID]-log.md`
