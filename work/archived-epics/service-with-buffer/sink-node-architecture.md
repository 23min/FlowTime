...
- `work/epics/completed/service-with-buffer/service-with-buffer-architecture-part2.md`
- `work/epics/completed/service-with-buffer/service-with-buffer-architecture.md`
