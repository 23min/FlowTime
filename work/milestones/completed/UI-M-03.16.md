...
- Document RED/GREEN transitions in `work/milestones/tracking/UI-M-03.16-tracking.md` as tests are added/passing.
...
- `work/milestones/completed/UI-M-03.12.md`
- `work/milestones/completed/UI-M-03.15.md`
