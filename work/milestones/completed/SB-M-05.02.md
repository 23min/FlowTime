...
- Log the change in `work/milestones/tracking/SB-M-05.02-tracking.md` (new tracking doc).
...
- Create `work/milestones/tracking/SB-M-05.02-tracking.md` when implementation starts.
