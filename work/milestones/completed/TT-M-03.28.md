...
References: docs/architecture/retry-modeling.md, work/epics/completed/time-travel/queues-shift-depth-and-initial-conditions.md, docs/performance/perf-log.md
