...
- **Milestone Document:** [`work/milestones/completed/SB-M-05.03.md`](../completed/SB-M-05.03.md)
...
- Logged the remaining router work (implicit router synthesis, helper removal) in `work/milestones/completed/SB-M-05.03.md` as a documented gap that spawns the follow-up milestone (`SB-M-05.03-router` placeholder).
...
**Files:** `docs/templates/template-authoring.md`, `templates/README.md`, `work/epics/completed/service-with-buffer/service-with-buffer-architecture.md`, `work/milestones/completed/SB-M-05.03.md`, `docs/releases/SB-M-05.03.md`
