...
- **Milestone Document:** [`work/milestones/completed/UI-M-03.23.md`](../milestones/UI-M-03.23.md)
...
- SLA > 100% observed on legacy run
  ...
  - Architecture note: See work/epics/completed/time-travel/time-travel-architecture-ch3-components.md ("served > arrivals (conservation violation)") — oversupply should not appear on SLA channels. Either clamp `served <= arrivals` or route surplus to an explicit buffer/inventory node.
