...
- **Milestone Document:** [`work/milestones/completed/FT-M-05.06-performance.md`](../completed/FT-M-05.06-performance.md)
...
**Next Steps:**
- Capture a fresh HUD/CSV scrub run to verify the dial gating works under load, then wrap Phase 4 so we can schedule the follow-up UI-perf epic (`work/epics/completed/ui-perf/spec.md`).
