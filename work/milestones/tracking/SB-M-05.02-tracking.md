...
- **Milestone Document:** [`work/milestones/completed/SB-M-05.02.md`](../completed/SB-M-05.02.md)
...
**Files:** `docs/templates/template-authoring.md`, `templates/README.md`, `work/milestones/completed/SB-M-05.02.md`, `work/milestones/README.md`, `work/epics/completed/service-with-buffer/service-with-buffer-architecture.md`, `work/epics/epic-roadmap.md`
...
- Documented the DSL simplification + latency badges in `work/epics/completed/service-with-buffer/...` and aligned `work/milestones/completed/SB-M-05.02.md` + roadmap references.
