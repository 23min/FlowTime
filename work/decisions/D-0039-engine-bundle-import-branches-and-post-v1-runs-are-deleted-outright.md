...
**Decision:** Delete bundle-import branches from `POST /v1/runs` in M-0025 and delete the route itself. No 410-style rejection stub is retained. More generally, E-0019 cleanup milestones do not preserve obsolete first-party endpoints solely to tell callers where behavior moved.
