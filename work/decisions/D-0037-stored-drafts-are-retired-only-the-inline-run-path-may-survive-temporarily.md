...
**Decision:** Retire stored drafts entirely in M-0025. Delete `/api/v1/drafts` CRUD, `StorageKind.Draft`, and `data/storage/drafts/`. Keep only the inline-source `POST /api/v1/drafts/run` path until the Time Machine replacement is ready.
