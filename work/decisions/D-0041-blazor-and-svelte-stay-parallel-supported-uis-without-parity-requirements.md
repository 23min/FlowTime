...
**Status:** active
**Context:** E-0019 needed an explicit UI support policy so cleanup work would not silently turn into Blazor retirement or parity gating.
...
**Consequences:** M-0027 focuses on stale-wrapper removal and contract alignment, not UI retirement. Svelte is not blocked on missing Blazor features, and Blazor is not required to preserve deprecated compatibility paths.
