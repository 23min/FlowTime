---
id: D-0027
title: E-0016-04 uses one consolidated internal analytical result surface
status: accepted
---

**Status:** active
**Context:** M-0015 must move emitted-series truth, effective capacity, utilization, and graph-level flow latency into Core. An open design question was whether Core should return many narrow result types or one consolidated analytical result.
