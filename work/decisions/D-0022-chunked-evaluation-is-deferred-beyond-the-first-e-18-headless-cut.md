---
id: D-0022
title: Chunked evaluation is deferred beyond the first E-0018 headless cut
status: accepted
---
...
**Decision:** Split E-0018 into layers. The first cut covers the shared runtime parameter foundation, evaluation SDK, and headless CLI / sidecar. Advanced analysis modes (sweep, sensitivity, optimization, fitting) build on that. Chunked evaluation waits for a dedicated streaming/stateful execution seam.
