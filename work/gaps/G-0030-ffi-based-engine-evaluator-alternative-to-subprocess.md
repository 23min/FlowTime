...
For Studio (E-0023 as proposed), this boundary gets expensive:
...
- Before committing to “one Rust process per session” in M-0046/M-0047, prototype an FFI-based evaluator alongside the subprocess one and measure memory + cold start at realistic `N`.
