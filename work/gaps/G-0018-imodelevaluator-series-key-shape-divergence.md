...
Discovered during M-0010 implementation (2026-04-15). The two production
...
are not interchangeable. `RustEngineRunner` reads artifacts laid out per E-0020 conventions
