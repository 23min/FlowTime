...
- Symptom thread: recurring zero-byte `.git/index.lock` blocking `aiwf add` / `aiwf promote` operations; observed during M-066 wrap (2026-05-05) and E-26 epic creation (2026-05-05).
