---
id: G-0013
title: E-0018 Model Calibration Needs Crystal Ball Design Input
status: open
---

### Why this is a gap

E-0018 mentions "model fitting against real telemetry" in scope but defers it to the analysis layer. The crystal ball's prediction accuracy depends fundamentally on calibration — how well the model's capacity, failure rates, and retry kernels match reality.

Unresolved questions that should be design inputs when E-0018 fitting milestones are specced:
...
- E-0018 spec work should reference the crystal ball note when designing the fitting/optimization layer.
