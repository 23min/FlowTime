...
Per milestone confirmation #3, this was not retrofitted inside M-0043. The heatmap ships at the higher bar; topology remains at the earlier bar.

### Status

Open. Blazor UI's original topology had keyboard + ARIA; Svelte topology regressed here and the regression predates M-0043.

### Immediate implications

- Do not ship accessibility audits against the Svelte workbench as "complete" until topology reaches heatmap's bar.
- When a future milestone (likely M-0045 polish) adds pattern encoding / high-contrast tuning, include topology keyboard + ARIA retrofit in the same pass.
