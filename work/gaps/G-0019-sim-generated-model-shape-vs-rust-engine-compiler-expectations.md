...
(M-0040 sweep + sensitivity) against real runs. The Rust engine's
...
reduces friction but blurs the boundary that E-0016/E-0020 established.
Decision belongs to the engine epic owner — not in E-0021 scope.
