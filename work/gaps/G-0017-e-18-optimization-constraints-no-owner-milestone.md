---
id: G-0017
title: E-0018 Optimization Constraints (no owner milestone)
status: open
---

### Why this is a gap

`OptimizeSpec` has no constraint field. The E-0018 spec describes constraints as:

```
--constraint "max(node.queue.utilization) < 0.8"
```

This was explicitly deferred out of M-0009 because the Nelder-Mead implementation
...
A future E-0018 milestone (no ID assigned yet) should:
