...
M-03.02.01 brings simulation-mode orchestration to `/v1/runs`, allowing FlowTime to generate canonical gold bundles directly from FlowTime.Sim templates without telemetry captures. The release keeps telemetry behaviour intact while adding mode-aware validation, observability, and CLI parity.
