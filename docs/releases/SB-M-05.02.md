...
2. **Templates & Documentation**
   ...
   - `docs/templates/template-authoring.md`, `templates/README.md`, and `work/epics/completed/service-with-buffer/...` document the implicit DSL, scheduled dispatch authoring, the new queue-latency status, and the refresh-templates workflow.
   - `work/epics/completed/service-with-buffer/SB-M-05.02.md`, the milestone tracker, and the architecture roadmap were updated so SB-M-05.02 is the canonical reference for these behaviors.
