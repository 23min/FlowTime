...
2. **Templates & Documentation**
   ...
   - `work/milestones/completed/SB-M-05.02.md`, the milestone tracker, and the architecture roadmap were updated so SB-M-05.02 is the canonical reference for these behaviors.
