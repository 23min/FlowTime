...
5. **Focus view tests + tracking updates**  
   ...
   (`tests/FlowTime.UI.Tests/TimeTravel/TopologyFocusViewTests.cs`, `tests/FlowTime.UI.Tests/TimeTravel/TopologyCanvasRenderTests.cs`, `work/epics/completed/time-travel/FT-M-05.14-topology-focus-view.md`, `work/epics/completed/time-travel/FT-M-05.14-topology-focus-view-log.md`)
