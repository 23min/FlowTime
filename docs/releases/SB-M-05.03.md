...
- Router nodes still require helper series for arrivals/served/capacity. `docs/milestones/SB-M-05.03.md` documents the router follow-up milestone (“SB-M-05.03-router”) which will give routers the same implicit synthesizer treatment.
