...
> **Archived:** Superseded by the time-travel architecture chapters and planning roadmap in `work/epics/completed/time-travel/`. Retained here for historical reference.
**Date**: October 7, 2025  
