...
- [ ] Phase 2: File Sources (0/3 tasks)
...
**Checklist (TDD order):**
- [ ] RED: Write tests for happy path, sparse bins, invalid header, missing file, and bad indices.
- [ ] GREEN: Implement CSV reader using invariant culture and header validation.
...
**Checklist (TDD order):**
- [ ] RED: Tests for relative path resolution, absolute paths, unsupported schemes, and missing model directory.
- [ ] GREEN: Implement resolver logic.
...
**Checklist (TDD order):**
- [ ] RED: Tests loading required semantics, optional semantics, and error propagation from reader.
- [ ] GREEN: Implement loader using CSV reader + resolver.
