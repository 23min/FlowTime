...
- [ ] Parameter bundles support Sim’s declared parameter types (scalar primitives and arrays) with explicit defaults and required flags documented for UI orchestration.
