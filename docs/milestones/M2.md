# Milestone M2 — PMF Support

> **📋 Charter Notice**: This completed milestone predates the [FlowTime-Engine Charter](../flowtime-engine-charter.md). PMF functionality remains core to the charter execution engine. See [Charter Roadmap](CHARTER-ROADMAP.md) for current development milestones (M2.7-M2.9).
