...
See `service-with-buffer-architecture.md` in this folder for the detailed proposal and `docs/milestones/SB-M-04.01.md` for the corresponding milestone spec.
