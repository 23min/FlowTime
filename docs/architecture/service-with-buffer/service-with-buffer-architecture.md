...
**Related:** `docs/milestones/completed/CL-M-04.03.02.md` (Scheduled Dispatch & Flow Control), routing/classes epic, UI topology docs
...
The detailed breakdown lives in `docs/milestones/completed/SB-M-05.01.md`, but at a high level we will:
