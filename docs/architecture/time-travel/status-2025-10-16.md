...
- **Milestone status drift**: `docs/milestones/completed/M-03.01.md`, `docs/milestones/completed/M-03.02.md`, and `docs/milestones/completed/SIM-M-03.00.md` still claim Planned/In Progress despite code completion; tracking logs disagree.
