...
**Open question:** what next? Two engine-side gaps filed during E-21 dogfooding (see `work/gaps.md`) lean toward sequencing a testing-rigor / engine-investigation milestone before E-22 Model Fit. Alternatively: E-15 Telemetry Ingestion is the long-pole for the client-telemetry vision; E-22 depends on E-15 + Telemetry Loop & Parity per D-2026-04-15-032 Option A.
