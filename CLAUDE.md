...
- **E-23** Model Validation Consolidation (`work/epics/E-23-model-validation-consolidation/spec.md`) — **ready-to-resume (2026-04-25; rescoped 2026-04-26)** — E-24 Schema Alignment closed; E-23 spirit reframed.
  ...
  - **Milestone slate (3 milestones, all ready):**
    - **m-E23-01 Rule-Coverage Audit** — doc-only audit of every rule in `ModelValidator.cs`, `ModelParser.cs`, `SimModelBuilder.cs`, `RunOrchestrationService.cs`, `GraphService.cs`. Per-rule disposition: schema-covered / schema-add / adjunct / parser-justified / drop. Schema additions and `ModelSchemaValidator` adjuncts land where the audit needs them; negative-case canary (`RuleCoverageRegressionTests`) locks coverage in. No call-site changes. Replaces the original m-E23-01-schema-alignment milestone — schema-alignment work was absorbed by E-24 m-E24-03/m-E24-05; the unowned piece (`ModelValidator` rule audit) becomes the new m-E23-01 focus. Slug change avoids collision with E-24's "schema-alignment" slug.
