...
- **E-24** Schema Alignment (`work/epics/E-24-schema-alignment/spec.md`) — **in-progress** — epic interrupting E-23 at m-E23-01 (2026-04-24). Internal planning ratified **Option E (unify)** on 2026-04-24 per `D-2026-04-24-037`; 5-milestone plan below. **m-E24-01 Inventory & Design Decisions complete (2026-04-25, commit `c43e8c0`)**; **m-E24-02 Unify Model Type complete (2026-04-25, commits `131dd35` / `c4064bf` / `3806097` / `dece22f`); m-E24-03 Schema Unification complete (2026-04-25, commit `d6a3263`); m-E24-04 Parser/Validator Scalar-Style Fix complete (2026-04-25, commit `a7c984f`); m-E24-05 Canary Green + Hard Assertion next**. Post-m-E24-02 cleanup wave merged into epic 2026-04-25 (commit `5a2a31d`): three E-24 wake gaps resolved (`ProvenanceEmbedder` deleted, `GridDefinition.StartTimeUtc` → `Start`, Template `Legacy*` aliases dropped).
  ...
  - **Decisions:** `D-2026-04-24-036` (E-23 paused, E-24 created) · `D-2026-04-24-037` (Option E ratified; 5-milestone plan).
- **E-23** Model Validation Consolidation (`work/epics/E-23-model-validation-consolidation/spec.md`) — **paused (2026-04-24)** — pending E-24 Schema Alignment.
  - m-E23-01 surfaced 16 divergences beyond E-23's consolidation thesis; E-24 takes over the convergence work. E-23 resumes when E-24 closes; m-E23-02 (call-site migration) and m-E23-03 (`ModelValidator` delete) then become byte-trivial because `ModelSchemaValidator`, the schema, Sim's emitter, and the Engine reader will actually agree.
  - **Milestone status after pause:** m-E23-01 Schema Alignment — **paused (pending E-24)**; m-E23-02 Call-Site Migration — **pending (awaits E-24 close)**; m-E23-03 Delete `ModelValidator` — **pending (awaits E-24 close)**.
