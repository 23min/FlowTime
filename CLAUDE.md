...
- **Immediate next step:** implement m-E20-01 Scaffold, Types, and Parsers on `milestone/m-E20-01-scaffold-types-parsers`.
- **E-20** Matrix Engine (`work/epics/E-20-matrix-engine/spec.md`) — **in progress (m-E20-01)**
  - Rust column-store + evaluation-plan engine. Standalone CLI binary. Foundation for E-17/E-18.
  - **In progress:** m-E20-01 (scaffold, model types, YAML parsing, expression parser) on `milestone/m-E20-01-scaffold-types-parsers`.
