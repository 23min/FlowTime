...
- **E-23** Model Validation Consolidation (`work/epics/E-23-model-validation-consolidation/spec.md`) — **in-progress (m-E23-01 completed 2026-04-26; m-E23-02 ready)** — E-24 Schema Alignment closed; E-23 spirit reframed.
  ...
  - **Milestone slate (3 milestones):**
    ...
    - **m-E23-02 Call-Site Migration** — switch `POST /v1/run`, Engine CLI, `TimeMachineValidator` tier-1 + four test files from `ModelValidator.Validate` to `ModelSchemaValidator.Validate`; error-phrasing audit; `ModelValidator.cs` left on disk as single-revert safety net.
